...
export function getConfig(): Config {
  ...
  cachedConfig = {
    ...
    multiQueryConcurrency: envInt('WIGOLO_MULTI_QUERY_CONCURRENCY', 2, settings, 'multiQueryConcurrency'),
    multiQueryMax: envInt('WIGOLO_MULTI_QUERY_MAX', 5, settings, 'multiQueryMax'),
